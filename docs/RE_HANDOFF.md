...
| Active | `BulletUpdateRuntime @ 0x00406240` | The 885-byte per-bullet owner remains non-exact. Re-audit of the structured caller report corrects the stale “885/885” State8 checkpoint: with horizontal, vertical and State8 member seams connected, the selected real split-TU `/GL /GS` candidate is 887/885 bytes with 86/729 normalized comparable bytes (88 raw), complete normalization. State8 itself is now canonical 306/306 exact. Continue the caller work from this corrected 887-byte baseline rather than the stale size note. |
