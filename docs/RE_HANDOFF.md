...
| Active | `BulletUpdateRuntime @ 0x00406240` | The 885-byte per-bullet owner remains non-exact. Reconnecting the target-proven horizontal and vertical wrap members through the real split-TU caller graph changes the selected `BulletRuntime.cpp + BulletManager.cpp + AnmManager.cpp + EnemyEclDispatcher.cpp /GL /GS` candidate from the 861/885, 68/733 checkpoint to target-sized 885/885 with 83/733 normalized comparable bytes (85 raw), complete normalization. Horizontal contributes 148/148 with 54/116 comparable bytes; vertical contributes 166/172 with 38/140. This is a physical-context checkpoint, not exactness. Existing eight canonical exact units sourced from BulletManager.cpp cold-replay 1355/1355 bytes after both seam changes. |
