...
| Source-present mappings | 336 |
| Source-present with authored origin | 330 |
| Source-present origin review pending | 0 |
| Source-present origin indeterminate | 6 |
| Authored source-present exact backlog | 137 |
| Canonical exact functions | 195 |
| Canonical exact codegen bytes | 24,657 |
| Canonical exact functions with authored origin | 193 |
| Canonical exact authored bytes | 24,575 |
