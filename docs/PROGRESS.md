...
| Source-present mappings | 333 |
| Source-present with authored origin | 327 |
...
| Canonical exact codegen bytes | 24,490 |
| Canonical exact functions with authored origin | 190 |
| Canonical exact authored bytes | 24,408 |
