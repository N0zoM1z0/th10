...
| Source-present mappings | 354 |
| Source-present with authored origin | 343 |
...
| Canonical exact codegen bytes | 25,360 |
| Canonical exact functions with authored origin | 203 |
| Canonical exact authored bytes | 25,131 |
