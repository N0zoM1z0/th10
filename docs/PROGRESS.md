...
| Canonical exact functions | 217 |
| Canonical exact codegen bytes | 25,731 |
| Canonical exact functions with authored origin | 210 |
| Canonical exact authored bytes | 25,409 |
