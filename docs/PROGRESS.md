...
| Canonical exact functions | 198 |
| Canonical exact codegen bytes | 24,898 |
| Canonical exact functions with authored origin | 196 |
| Canonical exact authored bytes | 24,816 |
