...
| Source-present mappings | 361 |
| Source-present with authored origin | 350 |
...
| Canonical exact codegen bytes | 25,943 |
| Canonical exact functions with authored origin | 215 |
| Canonical exact authored bytes | 25,621 |
