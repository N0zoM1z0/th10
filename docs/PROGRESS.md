...
| Source-present mappings | 352 |
| Source-present with authored origin | 341 |
...
| Canonical exact codegen bytes | 25,228 |
| Canonical exact functions with authored origin | 201 |
| Canonical exact authored bytes | 24,999 |
